...
public class FeatureExtraction {
	...
	public static String featureFilePath = "/home/hjp/Downloads/ftrain" + value + ".txt";
	public static String tagFilePath = "/home/hjp/Downloads/gtrain" + value + ".txt";
	
	public static String featureTestFilePath = "/home/hjp/Downloads/ftest" + value + ".txt";
	public static String tagTestFilePath = "/home/hjp/Downloads/gtest" + value + ".txt";

	public static void main(String[] args) {
		long start = System.currentTimeMillis();
		String filePath = "/home/hjp/Downloads/train.txt";
		writeTagFile("3\r\n");
		readFile(filePath);
		...
		String testFile = "/home/hjp/Downloads/test.txt";
	...
	public static void featTestSequence(String feature) {
		...
		if (testTestIndex(feature) > value) {
			if (featVec.length() < 1) {
